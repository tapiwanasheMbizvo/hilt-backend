...
public class BusinessActivityService {
    ...
    private static final Logger logger = Logger.getLogger(BusinessActivityService.class.getName());
    ...
    public BusinessUnitDto createBusinessUnit(BusinessUnitDto businessUnitDto) {
        ...
        logger.info("SAVING");
        logger.info(businessUnitDto.getBusinessEmail());
        logger.info(businessUnitDto.getBusinessName());


        var existingBusinessUnit = businessUnitRepository
        .findByBusinessNameAndBusinessEmail(businessUnitDto.getBusinessName(), businessUnitDto.getBusinessEmail());

        logger.info(existingBusinessUnit.toString());
        logger.info("#####");        
